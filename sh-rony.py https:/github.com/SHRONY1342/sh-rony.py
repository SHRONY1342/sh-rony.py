...
\033[0;94m  ______ _____ _   ___   __ 
...
\033[0;96m  \_| \_|\___/\_| \_/ \_/

""")

print("\033[0;91mThis Tool's Free By Alex Rony")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Alex Rony'

    print '\033[0;94mFACEBOOK : Alex Rony'

    print '\033[0;96mGITHUB   : SH_Rony'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Rony-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Rony-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
